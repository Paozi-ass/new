    ...
    <div class="weui-tab__bd proinfo-tab-con">
      <div id="tab1" class="weui-tab__bd-item weui-tab__bd-item--active">
        ...
        <div class="swiper-container swiper-zhutu">
          <div class="swiper-wrapper">
            <div class="swiper-slide"><img src="{{asset('storage/'.$data->g_img)}}" /></div>
            
          </div>
          <div class="swiper-pagination swiper-zhutu-pagination"></div>
        </div>
        <div class="wy-media-box-nomg weui-media-box_text">
          <h4 class="wy-media-box__title">{{$data->g_name}}</h4>
          <div class="wy-pro-pri mg-tb-5">¥<em class="num font-20">{{$data->g_price}}</em></div>
      ...
      <div id="tab2" class="weui-tab__bd-item ">
        <div class="pro-detail">
          <img src="{{asset('storage/'.$data->g_img)}}" /><img src="/static/upload/xq2.jpg" /><img src="/static/upload/xq3.jpg" /><img src="/static/upload/xq4.jpg" /><img src="/static/upload/xq5.jpg" /><img src="/static/upload/xq6.jpg" /><img src="/static/upload/xq7.jpg" /><img src="/static/upload/xq8.jpg" /><img src="/static/upload/xq9.jpg" />
        </div>
      </div>
      <div id="tab3" class="weui-tab__bd-item">
        ...
        <div class="weui-panel__bd">
          <div class="wy-media-box weui-media-box_text">
            <div class="weui-cell nopd weui-cell_access">
              <div class="weui-cell__hd"><img src="/static/upload/headimg.jpg" alt="" style="width:20px;margin-right:5px;display:block"></div>
            ...
            <ul class="weui-/static/uploader__files clear mg-com-img">
                <li class="weui-/static/uploader__file" style="background-image:url(.//static/upload/pro3.jpg)"></li>
                <li class="weui-/static/uploader__file" style="background-image:url(.//static/upload/pro3.jpg)"></li>
                <li class="weui-/static/uploader__file" style="background-image:url(.//static/upload/pro3.jpg)"></li>
            </ul>
          </div>
        ...
        <div class="weui-panel__bd">
          <div class="wy-media-box weui-media-box_text">
            ...
            <p class="weui-media-box__desc">面料不错，码数也正常  男朋友面料不错，码数也正常  男朋友穿的面料不错，码数也正常  男朋友穿的穿的很合适。</p>
            <ul class="weui-/static/uploader__files clear mg-com-img">
                <li class="weui-/static/uploader__file" style="background-image:url(.//static/upload/pro3.jpg)" onclick="window.location.reload('gallery.html')"></li>
                <li class="weui-/static/uploader__file" style="background-image:url(.//static/upload/ban2.jpg)" onclick="window.location.reload('gallery.html')"></li>
                <li class="weui-/static/uploader__file" style="background-image:url(.//static/upload/pro3.jpg)" onclick="window.location.reload('gallery.html')"></li>
            </ul>
          </div>
        </div>
